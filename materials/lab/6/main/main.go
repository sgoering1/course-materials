...
func main() {
    ...
    TODO_2 router.HandleFunc("/addsearch/{regex}", scrape.AddRegEx).Methods("GET")
    TODO_3 router.HandleFunc("/clear", scrape.Clear).Methods("GET")
    TODO_4 router.HandleFunc("/reset", scrape.RESETARRAY).Methods("GET")
